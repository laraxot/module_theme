<div class="card-wrapper shadow-sm rounded cmp-list-card-img">
    <div class="card card-img no-after rounded">
            ...
            <div class="img-responsive img-responsive-panoramic h-100">
                @if (isset($img_src))
                    <figure class="img-wrapper">
                        <img class="rounded-top img-fluid" src="{{ $img_src }}" title="titolo immagine"
        ...
        <div class="card-body">
            ...
            <a class="read-more t-primary text-uppercase cmp-list-card-img__body-link" href="#"
                aria-label="Leggi di più sulla pagina di {{ $title }}">
