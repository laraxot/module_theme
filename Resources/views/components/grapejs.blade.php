...
//dai preset si possono  copiare i componenti
...
>>>>>>> ede0df7 (first)
            ...
            editor.BlockManager.add('my-ribbon-id', {
                //mettendo category si aggiunge una nuova categoria per raggruppare i blocchi
                category: 'Components',
                label: '<b>Ribbon</b>',
                attributes: {
            ...
            editor.BlockManager.add('swiper', {
                category: 'Components',
                label: '<b>Swiper</b>',
                attributes: {
                    class: 'gjs-block-section'
