...
/******/ (function (modules) {
    ...
    /******/ })(
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            .directive(
                'autocomplete', ['$parse', '$injector', function ($parse, $injector) {
                    ...
                    return {
                        ...
                        link: function (scope, element, attrs) {
                            ...
                            element.bind(
                                'autocomplete:selected', function (object, suggestion, dataset) {
                            ...
                            element.bind(
                                'autocomplete:autocompleted', function (object, suggestion, dataset) {
                            ...
                            element.bind(
                                'autocomplete:cursorchanged', function (event, suggestion, dataset) {
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            _.mixin(
                Typeahead.prototype, {
                    ...
                    _bindKeyboardShortcuts: function (options) {
                        ...
                        _.each(
                            options.keyboardShortcuts, function (key) {
            ...
            function destroyDomStructure($node, cssClasses)
            {
                ...
                _.each(
                    $input.data(attrsKey), function (val, key) {
                        if (val === undefined) {
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function Input(o)
            {
                ...
                if (!_.isMsie()) {
                    ...
                    this.$input.on(
                        'keydown.aa keypress.aa cut.aa paste.aa', function ($e) {
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            _.mixin(
                Dropdown.prototype, EventEmitter, {
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            _.mixin(
                Dataset.prototype, EventEmitter, {
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            module.exports = function search(index, params)
            {
                ...
                {
                    index.search(
                        query, params, function (error, content) {
                            if (error) {
                    ...
                    index.search(
                        query, params, function (error, content) {
                            ...
                            if (content.hits.length > 0) {
                                ...
                                detailsIndex.search(
                                    source(first), detailsParams, function (error2, content2) {
                                        if (error2) {
                                        ...
                                        _.each(
                                            content2.facets, function (values, facet) {
                                                _.each(
                                                    values, function (count, value) {
                                                        suggestions.push(
                                                            _.mixin(
                                                                {
