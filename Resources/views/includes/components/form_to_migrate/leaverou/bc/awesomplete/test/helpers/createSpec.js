describe(
    "Awesomplete.$.create", function () {

        $.fixture("options");

        subject(
            function () {
                return Awesomplete.$.create(this.tag, this.options || {}) }
        );

        def("tag", "div");

        it(
            "creates DOM element", function () {
                expect(this.subject instanceof HTMLElement).toBe(true);
            }
        );

        describe(
            "with various tag names", function () {
                it(
                    "creates <ul> element", function () {
                        this.tag = "ul";
        ...
        describe(
            "without options", function () {
                it(
                    "creates element without any attributes", function () {
        ...
        describe(
            "with simple options", function () {
                it(
                    "assigns properties", function () {
        ...
        describe(
            "with option for boolean attribute/property", function () {
                it(
                    "assigns from true value", function () {
                ...
                it(
                    "assigns from truthy value", function () {
                ...
                it(
                    "assigns from false value", function () {
                ...
                it(
                    "assigns from falsy value", function () {
                        this.options = { hidden: "" };
                        expect(this.subject.hasAttribute("hidden")).toBe(false);
                    }
                );
        ...
        describe(
            "with inside: option", function () {
                it(
                    "appends to container by element", function () {
                ...
                it(
                    "appends to container by selector", function () {
                        this.options = { inside: "#data-list" };
        ...
        describe(
            "with around: option", function () {
                it(
                    "wraps specified element", function () {
                ...
                it(
                    "wraps element specified by selector", function () {
                        this.options = { around: "#no-options" };
