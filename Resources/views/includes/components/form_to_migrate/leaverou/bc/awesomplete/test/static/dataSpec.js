describe(
    "Awesomplete.DATA", function () {

        subject(
            function () {
                return Awesomplete.DATA(this.item) }
        );

        it(
            "returns original String", function () {
        ...
        it(
            "returns original Object", function () {
        ...
        it(
            "returns original Array", function () {
