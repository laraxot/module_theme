describe(
    "Awesomplete.$.unbind", function () {
        ...
        subject(
            function () {
                return function () {
                    Awesomplete.$.unbind(this.element, this.events) };
            }
        );

        describe(
            "with invalid element", function () {
                it(
                    "does nothing if element is undefined", function () {
                ...
                it(
                    "does nothing if element is null", function () {
                        this.element = null;
                        expect(this.subject).not.toThrow();
                    }
                );
                ...
                it(
                    "does nothing if element is false", function () {
                        this.element = false;
                        expect(this.subject).not.toThrow();
                    }
                );
                ...
                it(
                    "does nothing if element is 0", function () {
                        this.element = 0;
                        expect(this.subject).not.toThrow();
                    }
                );
                ...
                it(
                    "does nothing if element is empty string", function () {
                        this.element = "";
                        expect(this.subject).not.toThrow();
                    }
                );
        ...
        describe(
            "with valid element", function () {
                ...
                it(
                    "removes event listeners for all events", function () {
                ...
                it(
                    "removes single event listener for multiple events", function () {
