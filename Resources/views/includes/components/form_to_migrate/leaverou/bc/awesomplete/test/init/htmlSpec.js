describe(
    "Html modifications", function () {
        ...
        it(
            "binds to correct input", function () {
        ...
        describe(
            "HTML tweaks", function () {
                ...
                it(
                    "places input inside container", function () {
                ...
                it(
                    "puts list inside container", function () {
        ...
        describe(
            "ARIA support", function () {
                it(
                    "makes input accessible", function () {
