describe(
    "Awesomplete list", function () {
        ...
        it(
            "is empty if not provided", function () {
        ...
        describe(
            "setter", function () {
                ...
                it(
                    "assigns from element specified by selector", function () {
                ...
                it(
                    "does not assigns from not found list", function () {
                ...
                it(
                    "does not assigns from empty list", function () {
        ...
        describe(
            "constructor option", function () {
                ...
                it(
                    "assigns from list specified by element", function () {
                        this.options = { list: $("#data-list") };
                        expect(this.subject._list).toEqual(
                            [
                            { label: "With", value: "With" },
        ...
        describe(
            "data-list html attribute", function () {
                it(
                    "assigns from comma separated list", function () {
                ...
                it(
                    "assigns from element referenced by selector", function () {
        ...
        describe(
            "list html attribute", function () {
                it(
                    "assigns from element referenced by id", function () {
