describe(
    "Awesomplete.$.fire", function () {
        ...
        describe(
            "fires different event types", function () {
                it(
                    "fires click event", function () {
                        this.subject("click");
        ...
        describe(
            "sets event properties", function () {
                it(
                    "makes cancelable event", function () {
                        this.subject("click");
                ...
                it(
                    "can't make non cancelable event", function () {
                ...
                it(
                    "makes event that bubbles", function () {
                        this.subject("click");
                ...
                it(
                    "can't make event that does not bubble", function () {
                ...
                it(
                    "sets properties on the event", function () {
