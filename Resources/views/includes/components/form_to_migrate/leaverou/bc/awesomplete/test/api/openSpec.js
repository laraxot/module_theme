describe(
    "awesomplete.open", function () {
        ...
        xit(
            "fills in the list on creation", function () {
                $("#plain").value = "ite";
                this.subject.open();
        ...
        describe(
            "with autoFirst: true", function () {
                ...
                it(
                    "selects first item if wasn't seleted before", function () {
                        this.subject.open();
                ...
                it(
                    "does not select any item if was seleted before", function () {
        ...
        it(
            "fires awesomplete-open event", function () {
