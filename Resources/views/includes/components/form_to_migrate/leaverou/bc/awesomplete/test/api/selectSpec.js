describe(
    "awesomplete.select", function () {
        ...
        def(
            "lastIndex", function () {
                return this.subject.ul.children.length - 1 }
        );
        def(
            "lastLi", function () {
                return this.subject.ul.children[this.lastIndex] }
        );
        ...
        describe(
            "with opened completer", function () {
                beforeEach(
                    function () {
                        this.subject.open();
                    }
                ...
                describe(
                    "and item specified as argument", function () {
                        def(
        ...
        {
            it(
                "fires awesomplete-select event", function () {
            ...
            describe(
                "and awesomplete-select event was not prevented", function () {
                    ...
                    it(
                        "changes the input value", function () {
                            this.subject.select(this.selectArgument);
                    ...
                    it(
                        "fires awesomplete-selectcomplete event", function () {
            ...
            describe(
                "and awesomplete-select event was prevented", function () {
                    beforeEach(
                        function () {
                            $.on(
                                this.subject.input, "awesomplete-select", function (evt) {
                                    evt.preventDefault() }
                            );
                        }
                    );
                    ...
                    it(
                        "does not change the input value", function () {
                            this.subject.select(this.selectArgument);
                    ...
                    it(
                        "does not close completer", function () {
                            spyOn(this.subject, "close");
                            this.subject.select(this.selectArgument);
                    ...
                    it(
                        "does not fire awesomplete-selectcomplete event", function () {
                            var handler = $.spyOnEvent(this.subject.input, "awesomplete-selectcomplete");
                            this.subject.select(this.selectArgument);
        ...
        function itDoesNotSelectAnyItem()
        {
            ...
            it(
                "does not fire awesomplete-select event", function () {
                    var handler = $.spyOnEvent(this.subject.input, "awesomplete-select");
                    this.subject.select();
