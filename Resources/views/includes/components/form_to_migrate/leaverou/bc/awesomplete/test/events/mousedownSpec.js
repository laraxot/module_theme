describe(
    "mousedown event", function () {
        ...
        def(
            "li", function () {
                return this.subject.ul.children[1] }
        );
        ...
        describe(
            "with ul target", function () {
                def(
                    "target", function () {
                        return this.subject.ul }
                );

                it(
                    "does not select item and keeps the input focussed", function () {
        ...
        describe(
            "with child of li target", function () {
                def(
                    "target", function () {
                        return $("mark", this.li) }
                );
