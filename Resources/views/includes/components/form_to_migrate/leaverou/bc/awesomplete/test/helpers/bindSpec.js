describe(
    "Awesomplete.$.bind", function () {
        ...
        subject(
            function () {
                return function () {
                    Awesomplete.$.bind(this.element, this.events) };
            }
        );
        ...
        describe(
            "with valid element", function () {
                ...
                it(
                    "adds event listeners for all events", function () {
                ...
                it(
                    "adds single event listener for multiple events", function () {
