describe(
    "awesomplete.evaluate", function () {
        ...
        describe(
            "with too short input value", function () {
                beforeEach(
                    function () {
        ...
        describe(
            "with some items found", function () {
                ...
                it(
                    "fills completer with found items", function () {
                        this.subject.evaluate();
                ...
                it(
                    "shows no more than maxItems", function () {
                ...
                it(
                    "makes no item selected", function () {
                        this.subject.evaluate();
        ...
        describe(
            "with minChars: 0", function () {
                ...
                it(
                    "fills completer with all items", function () {
                        this.subject.evaluate();
                        expect(this.subject.ul.children.length).toBe(3);
                    }
                );
