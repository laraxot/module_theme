describe(
    "keydown event", function () {
        ...
        it(
            "does nothing if not opened", function () {
                this.subject.close();
        ...
        it(
            "does not select on tab", function () {
                this.subject.next();
...
describe(
    "tabSelect option true ", function () {
        $.fixture("plain");
