describe(
    "awesomplete.goto", function () {
        ...
        it(
            "clears previous aria-selected", function () {
                this.subject.goto(0);
        ...
        it(
            "fires awesomplete-highlight event", function () {
        ...
        describe(
            "with item index = -1", function () {
                ...
                it(
                    "does not update status", function () {
                        expect(this.subject.status.textContent).toBe("item1, list item 1 of 3");
                    }
                );
            }
