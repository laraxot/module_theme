...
@endphp
<p class="editinplace col-lg-8" style="float:left;" data-url="{{ $model->update_url }}" data-field="{{ $name }}" data-prev-value="" data-null-error="{{ $alertError }}">{{-- number_format((int)$value, 2, ',', '.') --}}{{$value}}</p>
