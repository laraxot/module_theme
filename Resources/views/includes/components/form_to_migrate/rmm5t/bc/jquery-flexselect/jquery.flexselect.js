    ...
    $.extend(
        $.flexselect.prototype, {
            ...
            reloadCache: function () {
                ...
                this.cache = this.select.find("option").map(
                    function () {
                        name = $(this).text();
