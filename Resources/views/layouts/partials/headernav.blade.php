...
<nav class="navbar navbar-expand-md fixed-top navbar-transparent" color-on-scroll="500">
	<div class="container">
		<div class="navbar-translate">
			...
			<img class="img-rounded" src="{{ Theme::url('/theme/pub/img/logos/test.png') }}" alt="logo" height="40">
			</a>
...
<a class="navbar-brand" href="{{ url('/'.$lang) }}">
	<div itemscope itemtype="http://schema.org/Service">
			...
			<img itemprop="logo" class="img-rounded" src="{{ Theme::url('/theme/pub/img/logos/test.png') }}" alt="test logo" height="40"/>
