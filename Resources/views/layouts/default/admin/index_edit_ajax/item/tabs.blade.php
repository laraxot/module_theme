		...
		@php
			switch($routename){
				...
				case 'container0.container1.container2.index_edit':
					//container0.container2.container3.index_edit] not defined
					//ddd($row->post);
					$route=route('container0.container1.container2.container3.index_edit',array_merge($params,['item2'=>$row->post,'container3'=>$tab]));
				break;
				default:
					$route='#'.$routename; //container0.container1.container2.index_edit
					//ddd($routename);
				break; 
			}
