...
https://gis.stackexchange.com/questions/260151/geocoding-with-latitude-and-longitude-in-openlayers3 //ricerca

//--- comodo per ridurre le chiamate a google 
- https://nominatim.openstreetmap.org/search.php?q=mogliano+veneto+&format=xml&addressdetails=1&limit=1
- https://nominatim.openstreetmap.org/search?q=135+pilkington+avenue,+birmingham&format=json&polygon=1&addressdetails=1
- https://services.gisgraphy.com/geocoding/geocode?address=via%20vanzo,%2086%20mogliano%20veneto%20&country=IT   !!!
...
- https://community.tableau.com/thread/156513
...
//---- reverse //da ip del browser o da geoip scriviamo la citta'
- http://nominatim.openstreetmap.org/reverse?format=xml&lat=[LATITUDE]&lon=[LONGITUDE]&zoom=18&addressdetails=1


//altro pezzo di import restaurants
https://nominatim.openstreetmap.org/?format=json&addressdetails=1&q=restaurants+in+italy&format=xml&addressdetails=1&limit=100
