<div>
    <div class="modal fade" id="loginModal" tabindex="-1" wire:key="login-model" wire:ignore.self>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('username') is-invalid @enderror"
                                    id="exampleFormControlInput1" name="username" placeholder="Your Email"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror"
                                    id="password" name="password" placeholder="Your password" wire:model.lazy="password">
                                @error('password')
                                    <div id="invalidEmailFeedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
