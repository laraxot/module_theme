<div>
    ...
    <div class="form-group">
        ...
        <ul>
            ...
            <li>~N: ricerca di prossimità (NEAR) - "governo carroccio"~3 cerca governo e carroccio a distanza di 3 parole</li>
            <li>~N: ricerca di parole simili (FUZZY) - governo~2 cerca governo e parole simili (MASSIMO 2 lettere diverse. es. inverno)</li>
        </ul>
