                                    ...
                                    <a href="#"
                                        ...
                                        <div>
                                            ...
                                            @if ($addTeamMemberForm['role'] == $role->key)
                                                <svg class="ms-1 text-success font-weight-light" width="20" fill="none"
    ...
    <x-dialog-modal wire:model="currentlyManagingRole">
        ...
        <x-confirmation-modal wire:model="confirmingLeavingTeam">
            ...
            <x-confirmation-modal wire:model="confirmingTeamMemberRemoval">
                ...
                <x-slot name="footer">
                    <x-secondary-button wire:click="$toggle('confirmingTeamMemberRemoval')"
                        wire:loading.attr="disabled">
                        {{ __('Cancel') }}
                        </x-jet-secondary-button>

                        <x-danger-button class="ms-2" wire:click="removeTeamMember"
                            wire:loading.attr="disabled">
                            {{ __('Remove') }}
                            </x-jet-danger-button>
                </x-slot>
