...
(function () {
    ...
    var tab = function () {
        var shortcutList = map(
            KeyboardShortcuts.shortcuts, function (shortcut) {
    ...
    var tab$1 = function (editor) {
        var availablePlugins = function () {
            ...
            var premiumPluginList = map(
                premiumPlugins, function (plugin) {
