...
(function (domGlobals) {
    ...
    var getPatternSet = function (editorSettings) {
        ...
        each(
            normalized.errors, function (err) {
    ...
    var isBlockFormatName = function (name, formatter) {
        ...
        return isArray(formatSet) && head(formatSet).exists(
            function (format) {
    ...
    var resolvePath = function (root, path) {
        ...
        return foldl(
            nodePath, function (optNode, index) {
                return optNode.bind(
                    function (node) {
    ...
    var resolvePathRange = function (root, range) {
        return resolvePath(root, range.start).bind(
            function (_a) {
                var startNode = _a.node, startOffset = _a.offset;
                return resolvePath(root, range.end).map(
                    function (_a) {
    ...
    var stripPattern = function (dom, block, pattern) {
        ...
        firstTextNode.each(
            function (node) {
                scanRight(node, pattern.start.length, block).each(
                    function (end) {
    ...
    var applyPattern = function (editor, match) {
        ...
        getParentBlock(editor, rng).each(
            function (block) {
    ...
    var findPatterns = function (editor, patterns) {
        ...
        return getParentBlock(editor, rng).filter(
            function (block) {
    ...
    var nodeMatchesPattern = function (dom, block, content) {
        return function (phase, element, text, optOffset) {
            ...
            if (startIndex !== -1) {
                ...
                return scanLeft(element, startEndIndex + 1 - content.length, block).fold(
                    function () {
    ...
    var findPatternStart = function (dom, pattern, node, offset, block, requireGap) {
        ...
        return textBefore(node, offset, block).bind(
            function (spot) {
    ...
    var findPattern$1 = function (editor, block, details) {
        ...
        return scanLeft(endNode, endOffset - details.pattern.end.length, block).bind(
            function (spot) {
    ...
    var findPatternsRec = function (editor, patterns, node, offset, block) {
        var dom = editor.dom;
        return textBefore(node, offset, dom.getRoot()).bind(
            function (endSpot) {
                var rng = dom.createRng();
    ...
    var applyPattern$1 = function (editor, pattern, patternRange) {
        ...
        if (pattern.type === 'inline-format') {
            each(
                pattern.format, function (format) {
    ...
    var addMarkers = function (dom, matches) {
        ...
        return foldr(
            matchesWithEnds, function (acc, match) {
    ...
    var findPatterns$1 = function (editor, patterns, space) {
        ...
        return getParentBlock(editor, rng).bind(
            function (block) {
    ...
    var applyMatches$1 = function (editor, matches) {
        ...
        each(
            matchesWithMarkers, function (match) {
                    ...
                    spot.each(
                        function (s) {
                            if (s.element.data.charAt(s.offset - 1) === zeroWidth()) {
                                ...
                                cleanEmptyNodes(
                                    editor.dom, s.element.parentNode, function (e) {
    ...
    var checkKeyCode = function (codes, event) {
        return checkKeyEvent(
            codes, event, function (code, event) {
    ...
    var checkCharCode = function (chars, event) {
        return checkKeyEvent(
            chars, event, function (chr, event) {
