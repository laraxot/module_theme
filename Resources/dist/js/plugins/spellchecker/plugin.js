...
(function (domGlobals) {
    ...
    var addToDictionary = function (editor, pluginUrl, startedState, textMatcherState, currentLanguageState, word, spans) {
        editor.setProgressState(true);
        sendRpcCall(
            editor, pluginUrl, currentLanguageState, 'addToDictionary', word, function () {
                editor.setProgressState(false);
    ...
    var ignoreWord = function (editor, startedState, textMatcherState, word, spans, all) {
        ...
        if (all) {
            global$1.each(
                editor.dom.select('span.mce-spellchecker-word'), function (span) {
    ...
    var buildMenuItems = function (listName, languageValues) {
        var items = [];
        global$1.each(
            languageValues, function (languageValue) {
                items.push(
                    {
                        selectable: true,
    ...
    var getItems = function (editor) {
        return global$1.map(
            Settings.getLanguages(editor).split(','), function (langPair) {
        ...
        var splitButtonArgs = __assign(
            __assign({}, buttonArgs), {
                ...
                fetch: function (callback) {
                    var items = global$1.map(
                        languageMenuItems, function (languageItem) {
                            return {
                                type: 'choiceitem',
    ...
    {
        global.add(
            'spellchecker', function (editor, pluginUrl) {
