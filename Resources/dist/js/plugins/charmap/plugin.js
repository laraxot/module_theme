...
(function (domGlobals) {
    ...
    var extendCharMap = function (editor, charmap) {
        ...
        if (userCharMapAppend) {
            var userDefinedGroup = global$1.grep(
                charmap, function (cg) {
