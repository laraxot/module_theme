...
(function () {
    ...
    var setup = function (editor) {
        editor.on(
            'PreProcess', function (o) {
                ...
                global$1.each(
                    dom.select('div', o.node), function (e) {
    ...
    var getPreviewContent = function (editor, html) {
        if (html.indexOf('<html>') === -1) {
            ...
            global$1.each(
                editor.contentCSS, function (url) {
    ...
    var open = function (editor, templateList) {
        var createTemplates = function () {
            ...
            return Option.from(
                global$1.map(
                    templateList, function (template, index) {
        ...
        var onChange = function (templates, updateDialog) {
            return function (api, change) {
                if (change.name === 'template') {
                    ...
                    findTemplate(templates, newTemplateTitle).each(
                        function (t) {
                            api.block('Loading...');
                            getTemplateContent(t).then(
        ...
        var onSubmit = function (templates) {
            return function (api) {
                ...
                findTemplate(templates, data.template).each(
                    function (t) {
                        getTemplateContent(t).then(
                            function (previewHtml) {
        ...
        var openDialog = function (templates) {
            ...
            getTemplateContent(templates[0]).then(
                function (previewHtml) {
