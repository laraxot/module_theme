...
(function (domGlobals) {
    ...
    var emojiMatches = function (emoji, lowerCasePattern) {
        return contains(emoji.title.toLowerCase(), lowerCasePattern) || exists(
            emoji.keywords, function (k) {
    ...
    var getUserDefinedEmoticons = function (editor) {
        ...
        return map$1(
            userDefinedEmoticons, function (value) {
                return merge(
                    {
                        keywords: [],
                        category: 'user'
    ...
    var open = function (editor, database) {
        ...
        var getInitialState = function () {
            var body = {
                type: 'tabpanel',
                tabs: map(
                    database.listCategories(), function (cat) {
                        return {
                            title: cat,
                            name: cat,
                            items: [
    ...
    {
        global.add(
            'emoticons', function (editor, pluginUrl) {
